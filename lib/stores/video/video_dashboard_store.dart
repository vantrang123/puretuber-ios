...
part 'video_dashboard_store.g.dart';

class VideoDashboardStore = _VideoDashboardStore with _$VideoDashboardStore;

abstract class _VideoDashboardStore with Store {
